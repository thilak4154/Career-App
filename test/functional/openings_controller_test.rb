...
class OpeningsControllerTest < ActionController::TestCase
  ...
  test "should create opening" do
    assert_difference('Opening.count') do
      post :create, opening: { experience: @opening.experience, jobtitle: @opening.jobtitle, skillset: @opening.skillset, technology: @opening.technology }
    end
  ...
  test "should update opening" do
    put :update, id: @opening, opening: { experience: @opening.experience, jobtitle: @opening.jobtitle, skillset: @opening.skillset, technology: @opening.technology }
    assert_redirected_to opening_path(assigns(:opening))
  end
